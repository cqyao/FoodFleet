        ...
        <View 
            ...
            <View style={{alignItems: "center",}}>
                <View style={{flexDirection: 'row'}}>
                    <TouchableOpacity style={styles.navButton} onPress={() => changeCategory('In Preparation')}>
                        <Text style={styles.navButtonText}>In Preparation</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.navButton} onPress={() => changeCategory('Delivered')}>
                        <Text style={styles.navButtonText}>Delivered</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.navButton} onPress={() => changeCategory('Cancelled')}>
